<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'PUT') {
        ...
        $query = "UPDATE appointments SET name='$appointment->vaccine_name', appointment_date='$appointment->appointment_date', 
        appointment_time='$appointment->appointment_time', appointment_user='$appointment->appointment_user', 
        appointment_team='$appointment->appointment_team', appointment_status='$appointment->appointment_status' 
